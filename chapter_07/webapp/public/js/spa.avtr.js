...
spa.avtr = (function () {
    ...
    var 
        ...
        getRandRgb, setJqueryMap, updateAvatar, onTapNav, onHeldstartNav, onHeldmoveNav, 
        onHeldendNav, onSetchatee, onListchange, onLogout, configModule, initModule;
    ...
    onHeldstartNav = function (event) {
        var offset_target_map, offset_nav_map, $target = $(event.elem_target).closest('.spa-avtr-box');
    ...
    onSetchatee = function (event, arg_map) {
        ...
        // remove highlight from old_chatee avatar
        if (old_chatee) {
            $nav
